              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input id="repo-url" placeholder="https://github.com/username/repository" className="flex-1" required />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="file-path" placeholder="e.g. src/main.py" className="flex-1" required />
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup defaultValue="full" className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="full" className="font-normal">Full Repository</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="changes" id="changes" />
                      <Label htmlFor="changes" className="font-normal">Recent Changes</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="specific" id="specific" />
                      <Label htmlFor="specific" className="font-normal">Specific Files</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="notes" placeholder="Any specific concerns or areas to focus on..." className="min-h-[100px]" />
                </div>
            ...
            <TabsContent value="upload" className="space-y-4 pt-4">
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex flex-col items-center justify-center space-y-2 border-2 border-dashed rounded-lg p-12">
                      ...
                      <div className="space-y-1 text-center">
                        ...
                        <p className="text-xs text-muted-foreground">Supports .js, .jsx, .ts, .tsx, .py, .java, .go, .rb, .php, and more</p>
                      </div>
                      <Button variant="outline" size="sm" className="mt-2 bg-background text-foreground">Browse Files</Button>
                    </div>
                  </CardContent>
                </Card>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="notes-upload" placeholder="Any specific concerns or areas to focus on..." className="min-h-[100px]" />
                </div>
...
//   // Split into list items using a regex for numbers (1. 2. etc.)
//   const listItems = text.split(/\n?\s*\d+\.\s*/).filter(item => item.trim() !== "");

//   return listItems.map((item, index) => {
//     // Highlight function names wrapped in backticks (e.g. `get_netrc_auth`)
//     const highlighted = item.replace(/`([^`]+)`/g, '<span class="font-bold text-blue-600">`$1`</span>');

//     return (
//       <li key={index} className="mb-2" dangerouslySetInnerHTML={{ __html: highlighted }} />
//     );
//   });
// }
